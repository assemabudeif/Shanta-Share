  ...
  return (
    <div className="grid grid-cols-3 gap-20 d-md-grid">
      <div className="detailsInfo mr-20">
        <span className="text-gray font-semibold text-l ml-20 titleInfo">{t("driverProfile.From")} <span className="text-gray valueInfo">{props.travelPost.address}</span></span><br />
