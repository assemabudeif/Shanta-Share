  ...
  return (
    <>
      <div className="grid grid-cols-12 md:max-w-[1920px]">
        ...
        <div className={`${isSidebarOpen ? "col-span-10" : "col-span-12"} w-full`}>
