                        ...
                        <>
                            <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
                                ...
                                <tr>
                                    ...
                                    <th
                                      className="border-b px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Client
                                        Name
                                    </th>
                                    <th
                                    ...
                                    <th
                                      className="border-b px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Pickup
                                        Time
                                    </th>
                                    <th
                                    ...
                                    <th
                                      className="border-b px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Delivery
                                        Fee
                                    </th>
                                    <th
                                      className="border-b px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Status
                                    </th>
                                    <th
                                      className="border-b px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Actions
                                    </th>
                                </tr>
                                </thead>
                                ...
                                {orders.map(order => (
                                  <tr key={order.id}>
                                      ...
                                      <td
                                        className="px-4 py-2 text-sm text-gray-800">{order.client?.name || 'Unknown'}</td>
                                      <td
                                        className="px-4 py-2 text-sm text-gray-800">{order.post?.from_city?.name || 'Unknown'}</td>
                                      <td
                                        className="px-4 py-2 text-sm text-gray-800">{order.post?.to_city?.name || 'Unknown'}</td>
                                      <td
                                        className="px-4 py-2 text-sm text-gray-800">{new Date(order.pickup_time).toLocaleString()}</td>
                                      <td
                                        className="px-4 py-2 text-sm text-gray-80">{new Date(order.arrival_time).toLocaleString()}</td>
                                      <td
                                        className="px-4 py-2 text-sm text-gray-80">{Math.round(order.post.delivery_fee)} EGP
                                      </td>
